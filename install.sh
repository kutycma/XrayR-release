...
install_XrayR() {
    ...
    file="https://github.com/kutycma/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/kutycma/XrayR-release/master/XrayR.sh
